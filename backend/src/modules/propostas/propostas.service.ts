  ...
  async create(user: AuthenticatedUser, dto: CreatePropostaDto): Promise<PropostaWithRel> {
    ...
    const created = await this.prisma.proposta.create({
      data: {
        ...
        prazoVerificacaoDias: dto.prazoVerificacaoDias,
        servicosTotal: dto.servicosTotal,
        customizacaoUnitario: dto.customizacaoUnitario,
        customizacaoQuantidade: dto.customizacaoQuantidade,
        subtotal: totals.subtotal,

---
updatedAt: 2026-05-27T10:42:38.000Z
---
...
Tutorial completo com cURL

# Criamos um passo a passo de um fluxo básico para solicitação de assinatura

Este guia apresenta um exemplo prático utilizando cURL para interagir com nossa API. Demonstramos como criar um envelope, adicionar documentos e signatários, configurar requisitos de assinatura, ativar o envelope e enviar solicitações de assinatura por e-mail.
...
Considerando que esteja em um `bash` com `cURL` instalado, execute os seguintes passos:

<Recipe slug="criação-e-configuração-do-envelope" title="Criação e Configuração do Envelope" />

1. **Definir Access Token**
...
5. **Disparar solicitações por e-mail:**

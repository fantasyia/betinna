---
updatedAt: 2025-10-06T19:05:45.000Z
---
...
Informe seu access_token

# Criar um Envelope

<!-- shell@3-15 -->

Cria um envelope com nome "Envelope de Teste" e armazena a chave retornada na variável envelope_id

# Adicionar um Documento

<!-- shell@17-30 -->

Adicionar um Documento ao Envelope, lembre de alterar o content_base64 para o do seu arquivo.

# Adicionar um Signatário com anfitrião

<!-- shell@32-52 -->

Adicionar um Signatário com Anfitrião ao Envelope.

# Criar um Requisito de Qualificação

<!-- shell@54-75 -->

É necessário ao menos um requisito de qualificação.

# Criar o Requisito de Autenticação

<!-- shell@78-99 -->

É necessário criar o requisito de assinatura presencial.

# Ativar um envelope

<!-- shell@101-113 -->

Altera o status do envelope para permitir assinaturas.

# Notificar os signatários

<!-- shell@115-125 -->

Envia notificação da solicitação aos signatários.
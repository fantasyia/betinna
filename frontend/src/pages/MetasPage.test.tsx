/**
 * MetasPage — spec de fumaça das páginas de DINHEIRO (auditoria: as 14 páginas onde
...
const { default: Pagina } = await import('./MetasPage');
...
describe('MetasPage — render de dinheiro', () => {
  it('renderiza a página com dados', () => {
    render(<Pagina />);
    expect(document.body.textContent).toContain('Meta de Faturamento');
  });

/**
 * DevolucoesPage — spec de fumaça das páginas de DINHEIRO (auditoria: as 14 páginas onde
  ...
  data: [
    {
      ...
      status: 'EM_ANALISE',
      motivo: 'avaria',
      valorDevolvido: 1250.4,
      itensDescricao: '2 caixas amassadas',
      criadoEm: '2026-08-01T12:00:00.000Z',
      criadoPorNome: 'João',
      pedidoId: 'ped-1',
      clienteId: 'cli-1',
      slaAnaliseEm: '2026-08-05T12:00:00.000Z',
      fotos: [],
    },
  ],
...
const { default: Pagina } = await import('./DevolucoesPage');
...
describe('DevolucoesPage — render de dinheiro', () => {
  it('renderiza a página com dados', () => {
    render(<Pagina />);
    expect(screen.queryByText(/DEV-0001/)).not.toBeNull();
  });

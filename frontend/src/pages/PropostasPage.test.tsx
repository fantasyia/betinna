/**
 * PropostasPage — spec de fumaça das páginas de DINHEIRO (auditoria: as 14 páginas onde
  ...
  data: [
    {
      ...
      valor: 8200.75,
      probabilidade: 60,
      validoAte: '2026-09-01T00:00:00.000Z',
...
const { default: Pagina } = await import('./PropostasPage');
...
describe('PropostasPage — render de dinheiro', () => {
  it('renderiza a página com dados', () => {
    render(<Pagina />);
    expect(screen.queryByText(/PROP-2026-001/)).not.toBeNull();
  });

/**
 * AmostrasPage — spec de fumaça das páginas de DINHEIRO (auditoria: as 14 páginas onde
  ...
  data: [
    {
      id: 'am-1',
      status: 'ENVIADA',
      produto: { id: 'prod-1', nome: 'Farinha' },
      quantidade: 2,
      valor: 320.5,
      enviadoEm: '2026-08-01T12:00:00.000Z',
      followUpEm: '2026-08-08T12:00:00.000Z',
      cliente: { id: 'cli-1', nome: 'Padaria do João' },
...
const { default: Pagina } = await import('./AmostrasPage');
...
describe('AmostrasPage — render de dinheiro', () => {

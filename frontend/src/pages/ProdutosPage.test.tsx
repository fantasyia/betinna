/**
 * ProdutosPage — spec de fumaça das páginas de DINHEIRO (auditoria: as 14 páginas onde
...
const { default: Pagina } = await import('./ProdutosPage');
...
describe('ProdutosPage — render de dinheiro', () => {
